...
class LoginScreen extends StatelessWidget {
 ...
 TextEditingController emailController =  TextEditingController(text: 'rewan@route.com');
 TextEditingController passwordController =  TextEditingController(text: '8888');
